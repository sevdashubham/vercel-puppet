...
function sizeOfRawNetwork(str, compression) {
    return compression === true
        ? sizeOfBytesWithLength(getCompressionSingleton().networkRaw.getCompressedSize(punycode_1.encode(str)), false)
        : sizeOfUTF8(str);
}
exports.sizeOfRawNetwork = sizeOfRawNetwork;
function sizeOfRawCosmetic(str, compression) {
    return compression === true
        ? sizeOfBytesWithLength(getCompressionSingleton().cosmeticRaw.getCompressedSize(punycode_1.encode(str)), false)
        : sizeOfUTF8(str);
}
...
class StaticDataView {
    ...
    pushRawCosmetic(str) {
        if (this.compression !== undefined) {
            this.pushBytes(this.compression.cosmeticRaw.compress(punycode_1.encode(str)));
        }
        else {
            this.pushUTF8(str);
        }
    ...
    getRawCosmetic() {
        if (this.compression !== undefined) {
            return punycode_1.decode(this.compression.cosmeticRaw.decompress(this.getBytes()));
        }
        return this.getUTF8();
    }
    pushRawNetwork(str) {
        if (this.compression !== undefined) {
            this.pushBytes(this.compression.networkRaw.compress(punycode_1.encode(str)));
        }
        else {
            this.pushUTF8(str);
        }
    ...
    getRawNetwork() {
        if (this.compression !== undefined) {
            return punycode_1.decode(this.compression.networkRaw.decompress(this.getBytes()));
        }
        return this.getUTF8();
    }
    checkSize() {
