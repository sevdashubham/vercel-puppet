...
exports.NORMALIZED_TYPE_TOKEN = {
    ...
    cspviolationreport: utils_1.fastHash('type:cspviolationreport'),
    ...
    preflight: utils_1.fastHash('type:preflight'),
    script: utils_1.fastHash('type:script'),
    signedexchange: utils_1.fastHash('type:signedexchange'),
