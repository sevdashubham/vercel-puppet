...
class CosmeticFilter {
    ...
    static parse(line, debug = false) {
        ...
        if (line.endsWith(':remove()')) {
            // ##selector:remove()
            mask = utils_1.setBit(mask, 64 /* remove */);
            mask = utils_1.setBit(mask, 128 /* extended */);
            line = line.slice(0, -9);
        }
        ...
        if (line.charCodeAt(suffixStartIndex) === 94 /* '^' */) {
            if (utils_1.fastStartsWithFrom(line, 'script:has-text(', suffixStartIndex + 1) === false ||
            ...
            const selectorType = adblocker_extended_selectors_1.classifySelector(selector);
        ...
        if (domains === undefined && utils_1.getBit(mask, 128 /* extended */) === true) {
            return null;
        }
        if (selector !== undefined) {
            ...
            if (utils_1.getBit(mask, 2 /* scriptInject */) === false &&
                utils_1.getBit(mask, 64 /* remove */) === false &&
                utils_1.getBit(mask, 128 /* extended */) === false &&
    ...
    getSerializedSize(compression) {
        ...
        if (this.rawLine !== undefined) {
            estimate += data_view_1.sizeOfRawCosmetic(this.rawLine, compression);
        }
        if (this.style !== undefined) {
    ...
    getStyleAttributeHash() {
        return `s${utils_1.fastHash(this.getStyle())}`;
    }
    getSelector() {
        return this.selector;
    }
    getSelectorAST() {
        return adblocker_extended_selectors_1.parse(this.getSelector());
    }
    getExtendedSelector() {
        return html_filtering_1.extractHTMLSelectorFromRule(this.selector);
    }
    isExtended() {
        return utils_1.getBit(this.mask, 128 /* extended */);
    }
    isRemove() {
        return utils_1.getBit(this.mask, 64 /* remove */);
    }
    isUnhide() {
